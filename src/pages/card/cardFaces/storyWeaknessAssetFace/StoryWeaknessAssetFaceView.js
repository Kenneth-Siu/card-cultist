...
export default function StoryWeaknessAssetFaceView({ faceDirection, listOfCardFaces, otherFace, face, cardSet }) {
    ...
    return (
        <BaseFaceView
            ...
            face={face}
            otherFace={otherFace}
            canvas={<StoryWeaknessAssetFaceCanvas face={face} cardSet={cardSet} setIllustrationTransform={setIllustrationTransform} />}
            fields={
                <>
