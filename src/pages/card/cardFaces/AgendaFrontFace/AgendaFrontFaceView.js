...
import "./AgendaFrontFaceView.scss";
...
export default function AgendaFrontFaceView({ typeSelect, face, cardSet, campaign, setCampaign }) {
        ...
        <div className="face-view agenda-front-face-view">
            ...
            <div className="form-container">
                ...
                <div className="input-container">
                    ...
                    <input
                        type="text"
                        value={face.agendaNumber}
                        onChange={(event) => setAgendaNumber(event.target.value)}
                    />
                </div>
                ...
                <div className="input-container">
                    <label>Doom Threshold</label>
                    <input
                        type="text"
                        value={face.doomThreshold}
                        onChange={(event) => setDoomThreshold(event.target.value)}
                    />
                    <label>
                        Per investigator?
    ...
    function setAgendaNumber(agendaNumber) {
        face.agendaNumber = agendaNumber;
    ...
    function setDoomThreshold(doomThreshold) {
        face.doomThreshold = doomThreshold;
        setCampaign(campaign.clone());
    }
