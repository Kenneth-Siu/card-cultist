...
export default function RogueBackFaceCanvas({ face, cardSet, setIllustrationTransform }) {
    ...
    useEffect(() => {
        setTextLayer(
            new CanvasTextLayer(
                new CanvasTextConfig()
                    .withText(face.text)
                    .withX((dy) => dy < 320 ? Math.min(392 - 0.114 * dy, 626 - dy) : 54)
                    .withY(160)
                    .withWidth((dy) => dy < 320 ? Math.max(618 + 0.114 * dy, 384 + dy) : 956)
