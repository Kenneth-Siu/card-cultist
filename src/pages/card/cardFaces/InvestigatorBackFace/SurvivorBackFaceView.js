...
export default function SurvivorBackFaceView({ faceDirection, listOfCardFaces, otherFace, face, cardSet }) {
    ...
    return (
        <BaseFaceView
            ...
            face={face}
            otherFace={otherFace}
            canvas={<SurvivorBackFaceCanvas face={face} cardSet={cardSet} setIllustrationTransform={setIllustrationTransform} />}
            fields={
                <>
