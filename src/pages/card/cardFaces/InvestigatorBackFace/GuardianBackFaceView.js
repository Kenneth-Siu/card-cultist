...
export default function GuardianBackFaceView({ faceDirection, listOfCardFaces, otherFace, face, cardSet }) {
    ...
    return (
        <BaseFaceView
            ...
            face={face}
            otherFace={otherFace}
            canvas={<GuardianBackFaceCanvas face={face} cardSet={cardSet} setIllustrationTransform={setIllustrationTransform} />}
            fields={
                <>
