...
export default function SurvivorBackFaceCanvas({ face, cardSet, setIllustrationTransform }) {
    ...
    useEffect(() => {
        setTextLayer(
            new CanvasTextLayer(
                new CanvasTextConfig()
                    .withText(face.text)
                    .withX((dy) => dy < 340 ? Math.min(376 - 0.114 * dy, 610 - dy) : 44)
                    .withY(160)
                    .withWidth((dy) => dy < 340 ? Math.max(610 + 0.114 * dy, 376 + dy) : 942)
