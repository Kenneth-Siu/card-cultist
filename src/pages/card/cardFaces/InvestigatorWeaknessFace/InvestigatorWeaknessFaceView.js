...
export default function InvestigatorWeaknessFaceView({ faceDirection, listOfCardFaces, otherFace, face, cardSet }) {
    ...
    return (
        <BaseFaceView
            ...
            face={face}
            otherFace={otherFace}
            canvas={<InvestigatorWeaknessFaceCanvas face={face} cardSet={cardSet} setIllustrationTransform={setIllustrationTransform} />}
            fields={
                <>
