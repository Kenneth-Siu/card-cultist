...
export default function StoryWeaknessEventFaceView({ faceDirection, listOfCardFaces, otherFace, face, cardSet }) {
    ...
    return (
        <BaseFaceView
            ...
            face={face}
            otherFace={otherFace}
            canvas={<StoryWeaknessEventFaceCanvas face={face} cardSet={cardSet} setIllustrationTransform={setIllustrationTransform} />}
            fields={
                <>
