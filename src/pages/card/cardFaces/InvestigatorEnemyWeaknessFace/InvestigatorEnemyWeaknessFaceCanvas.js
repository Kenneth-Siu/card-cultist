...
import EnemyFace from "./InvestigatorEnemyWeaknessFace";
...
import investigatorWeaknessOverlayImage from "../../../../../public/overlays/AHLCG-PersonalWeaknessEnemy.png";

export default function InvestigatorEnemyWeaknessFaceCanvas({ face, cardSet, setIllustrationTransform }) {
    ...
    const [investigatorWeaknessOverlayLayer, setInvestigatorWeaknessOverlayLayer] = useState(null);
    ...
    const canvasLayers = [
        illustrationLayer,
        frameLayer,
        investigatorWeaknessOverlayLayer,
        titleLayer,
        subtitleLayer,
        fightLayer,
        healthLayer,
    ...
    useEffect(async () => {
        setInvestigatorWeaknessOverlayLayer(
            new CanvasImageLayer(await loadPublicImage(investigatorWeaknessOverlayImage), new ImageTransform({
                x: 312,
                y: 524,
                scale: 1.95
            }))
